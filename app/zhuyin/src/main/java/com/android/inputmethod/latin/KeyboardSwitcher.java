...
public class KeyboardSwitcher {
	...
	private static final String TAG="ziime";
    ...
    public KeyboardSwitcher(ZhuYinIME context) {
        mContext = context;
    }

    public void setInputView(LatinKeyboardView inputView) {
    ...
    public void toggleABCIME(){
    	//Log.i(TAG, "KeyboardSwitcher:toggleABCIME");
    ...
    public void toggleZhuYinIME(){
    	//Log.i(TAG, "KeyboardSwitcher:toggleZhuYinIME");
