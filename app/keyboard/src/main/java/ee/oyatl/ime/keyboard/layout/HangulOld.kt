...
object HangulOld {
    ...
    val TABLE_OLD_393 = mapOf(
        KeyEvent.KEYCODE_GRAVE to listOf(0x11f9, 0x11f0),
        KeyEvent.KEYCODE_1 to listOf(0x11c2, 0x11bd),
        KeyEvent.KEYCODE_2 to listOf(0x11bb, 0x11eb),
        ...
        KeyEvent.KEYCODE_Y to listOf(0x1105, 0x302f),
        KeyEvent.KEYCODE_U to listOf(0x1103, 0x302e),
        KeyEvent.KEYCODE_I to listOf(0x1106, 0x1154),
        KeyEvent.KEYCODE_O to listOf(0x110e, 0x1155),
        KeyEvent.KEYCODE_P to listOf(0x1111, 0xb7),
        ...
        KeyEvent.KEYCODE_G to listOf(0x1173, 0x119e),
        KeyEvent.KEYCODE_H to listOf(0x1102, 0x27),
        KeyEvent.KEYCODE_J to listOf(0x110b, 0x114c),
        KeyEvent.KEYCODE_K to listOf(0x1100, 0x114e),
        KeyEvent.KEYCODE_L to listOf(0x110c, 0x1150),
        ...
        KeyEvent.KEYCODE_N to listOf(0x1109, 0x1140),
        KeyEvent.KEYCODE_M to listOf(0x1112, 0x1159),
        KeyEvent.KEYCODE_COMMA to listOf( 0x2c, 0x113c),
        KeyEvent.KEYCODE_PERIOD to listOf(0x2e, 0x113e),
        KeyEvent.KEYCODE_SLASH to listOf( 0x1169, 0x3f),

        ExtKeyCode.KEYCODE_390_0 to listOf(0x116e, 0x1140),
        ExtKeyCode.KEYCODE_390_1 to listOf(0x1109, 0x1159),
        ExtKeyCode.KEYCODE_390_2 to listOf(0x1112, 0x113c),
        ExtKeyCode.KEYCODE_390_3 to listOf(0x1110, 0x113e)
    )
