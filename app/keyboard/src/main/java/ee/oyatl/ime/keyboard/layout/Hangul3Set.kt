...
object Hangul3Set {
    ...
    val TABLE_391 = mapOf(
        ...
        KeyEvent.KEYCODE_9 to listOf(0x116e, 0x27),
        ...
        KeyEvent.KEYCODE_SLASH to listOf(0x1169, 0x21)
    )

    val COMBINATION_390_391 = mapOf(
