...
interface InputViewManager {
     ...
     *
     * @return      The input view created in the initialize process; `null` if cannot create a input view.
     */
    fun initView(parent: OpenWnn, width: Int, height: Int): View?

    /**
     * Get the input view being used currently.
     *
     * @return  The input view; `null` if no input view is used currently.
     */
     ...
     */
    fun onUpdateState(parent: OpenWnn)
     ...
     */
    fun setPreferences(pref: SharedPreferences, editor: EditorInfo)
