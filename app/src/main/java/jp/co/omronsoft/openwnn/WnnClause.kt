...
class WnnClause : WnnWord {
     ...
     */
    constructor(candidate: String?, stroke: String?, posTag: WnnPOS?, frequency: Int) : super(
        candidate,
        stroke,
        posTag,
        frequency
     ...
     */
    constructor(stroke: String?, stem: WnnWord) : super(
        stem.id,
        stem.candidate,
        stroke,
        stem.partOfSpeech,
     ...
     */
    constructor(stroke: String?, stem: WnnWord, fzk: WnnWord) : super(
        stem.id,
        stem.candidate + fzk.candidate,
        stroke,
        WnnPOS(stem.partOfSpeech!!.left, fzk.partOfSpeech!!.right),
        stem.frequency,
        1
    )
}
