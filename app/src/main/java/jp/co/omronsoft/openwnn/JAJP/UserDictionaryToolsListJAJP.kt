 ...
 */
class UserDictionaryToolsListJAJP : UserDictionaryToolsList() {
    /**
     * Constructor
     */
    init {
    ...
    override fun createUserDictionaryToolsEdit(
        ...
        return UserDictionaryToolsEditJAJP(view1, view2)
    }
    ...
    protected inner class ListComparatorJAJP : Comparator<WnnWord> {
