...
class Event private constructor(// The type of event - one of the constants above
    ...
    val mText: CharSequence?, codePoint: Int, keyCode: Int,
    x: Int, y: Int, suggestedWordInfo: SuggestedWordInfo?, flags: Int,
    next: Event?
) {
    ...
    companion object {
        ...
        const val EVENT_TYPE_GESTURE: Int = 4

        // An event corresponding to the manual pick of a suggestion.
        const val EVENT_TYPE_SUGGESTION_PICKED: Int = 5
