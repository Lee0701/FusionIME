...
class DeadKeyCombiner : Combiner {
    private object Data {
         ...
         */
        val sCombiningToAccent: SparseIntArray = SparseIntArray()
        val sAccentToCombining: SparseIntArray = SparseIntArray()
        ...
        fun addCombining(combining: Int, accent: Int) {
        ...
        fun addNonStandardDeadCombination(
            deadCodePoint: Int,
        ...
        const val NOT_A_CHAR: Int = 0
        const val BITS_TO_SHIFT_DEAD_CODE_POINT_FOR_NON_STANDARD_COMBINATION: Int = 16

        // Get a non-standard combination
        fun getNonstandardCombination(
            deadCodePoint: Int,
            spacingCodePoint: Int
        ): Char {
    ...
    override fun processEvent(previousEvents: MutableList<Event>, event: Event): Event {
        ...
        if (Character.isWhitespace(event.mCodePoint)
            ...
            val resultEvent = createEventChainFromSequence(
                mDeadSequence.toString(),
                event
            )
