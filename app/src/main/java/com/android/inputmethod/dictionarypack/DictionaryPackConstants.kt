...
object DictionaryPackConstants {
     ...
     */
    private const val DICTIONARY_DOMAIN: String = "com.android.inputmethod.dictionarypack.aosp"

    /**
     * Authority for the ContentProvider protocol.
     */
    // TODO: find some way to factorize this string with the one in the resources
    val AUTHORITY: String = DICTIONARY_DOMAIN
    ...
    // historical reasons.
    val NEW_DICTIONARY_INTENT_ACTION: String = DICTIONARY_DOMAIN + ".newdict"
     ...
     */
    val UNKNOWN_DICTIONARY_PROVIDER_CLIENT: String = (DICTIONARY_DOMAIN
            + ".UNKNOWN_CLIENT")

    // In the above intents, the name of the string extra that contains the name of the client
    // we want information about.
    const val DICTIONARY_PROVIDER_CLIENT_EXTRA: String = "client"

    /**
     * The action of the intent to tell the dictionary provider to update now.
     */
    val UPDATE_NOW_INTENT_ACTION: String = (DICTIONARY_DOMAIN
            + ".UPDATE_NOW")
     ...
     * and update now.
     */
    val INIT_AND_UPDATE_NOW_INTENT_ACTION: String = (DICTIONARY_DOMAIN
            + ".INIT_AND_UPDATE_NOW")
}
