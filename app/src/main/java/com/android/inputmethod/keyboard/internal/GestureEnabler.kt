...
class GestureEnabler {
    ...
    private var mShouldHandleGesture: Boolean = false
    private var mMainDictionaryAvailable: Boolean = false
    private var mGestureHandlingEnabledByInputField: Boolean = false
    private var mGestureHandlingEnabledByUser: Boolean = false
    ...
    fun shouldHandleGesture(): Boolean {
