...
object TextViewCompatUtils {
    ...
    private val METHOD_setCompoundDrawablesRelativeWithIntrinsicBounds: Method? =
        CompatUtils.getMethod(
            TextView::class.java, "setCompoundDrawablesRelativeWithIntrinsicBounds",
            Drawable::class.java,
            Drawable::class.java,
            Drawable::class.java,
            Drawable::class.java
    ...
    fun setCompoundDrawablesRelativeWithIntrinsicBounds(
        ...
        CompatUtils.invoke(
            textView, null, METHOD_setCompoundDrawablesRelativeWithIntrinsicBounds,
