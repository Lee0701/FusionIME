...
class SettingsValues(
    ...
    // From configuration:
    val mLocale: Locale = res.configuration.locale
    ...
    val mSlidingKeyInputPreviewEnabled: Boolean = prefs.getBoolean(
    ...
    val isLanguageSwitchKeyEnabled: Boolean
        get() {
    ...
    fun dump(): String {
        ...
        sb.append("\n   mAppWorkarounds = ")
        val awu = mAppWorkarounds[null, 0]
        sb.append("" + (awu?.toString() ?: "null"))
        sb.append("\n   mIsInternal = ")
    ...
    companion object {
        private val TAG: String = SettingsValues::class.java.simpleName
        ...
        private fun readAutoCorrectionThreshold(
            res: Resources,
            currentAutoCorrectionSetting: String
        ): Float {
