...
class SetupStartIndicatorView(context: Context?, attrs: AttributeSet?) :
    ...
    class LabelView(context: Context?, attrs: AttributeSet?) :
    ...
    class IndicatorView(context: Context?, attrs: AttributeSet?) :
        View(context, attrs) {
        private val mIndicatorPath = Path()
        private val mIndicatorPaint = Paint()
        private val mIndicatorColor = resources.getColorStateList(
