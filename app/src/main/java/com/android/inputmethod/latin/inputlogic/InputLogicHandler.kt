...
internal open class InputLogicHandler : Handler.Callback {
    ...
    var isInBatchInput: Boolean = false // synchronized using {@link #mLock}.
        private set
    ...
    fun destroy() {
        LooperCompatUtils.quitSafely(mNonUIThreadHandler!!.looper)
    }
    ...
    override fun handleMessage(msg: Message): Boolean {
        when (msg.what) {
            MSG_GET_SUGGESTED_WORDS -> mLatinIME!!.getSuggestedWords(
                msg.arg1,  /* inputStyle */
    ...
    private fun updateBatchInput(
        ...
        synchronized(mLock) {
            ...
            val callback =
                OnGetSuggestedWordsCallback { suggestedWords ->
                    showGestureSuggestionsWithPreviewVisuals(
                        suggestedWords,
                        isTailBatchInput
                    )
                }
    ...
    fun showGestureSuggestionsWithPreviewVisuals(
        ...
        mLatinIME!!.mHandler.showGesturePreviewAndSuggestionStrip(
            suggestedWordsToShowSuggestions,
    ...
    companion object {
        ...
        val NULL_HANDLER: InputLogicHandler = object : InputLogicHandler() {
            ...
            override fun updateTailBatchInput(
                batchPointers: InputPointers,
                sequenceNumber: Int
            ) {
            }
