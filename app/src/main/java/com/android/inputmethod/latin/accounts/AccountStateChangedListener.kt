 ...
 */
object AccountStateChangedListener {
    /**
     ...
     */
    fun onAccountSignedIn(oldAccount: String?, newAccount: String) {
    }
     ...
     */
    fun onSyncPreferenceChanged(account: String?, syncEnabled: Boolean) {
    }
     ...
     * @param account the account to use for sync.
     */
    fun forceDelete(account: String?) {
    }
}
