...
object LocalSettingsConstants {
    ...
    const val PREFS_FILE: String = "local_prefs"

    // Preference key for the current account.
    // Do not restore.
    const val PREF_ACCOUNT_NAME: String = "pref_account_name"

    // Preference key for enabling cloud sync feature.
    // Do not restore.
    const val PREF_ENABLE_CLOUD_SYNC: String = "pref_enable_cloud_sync"
    ...
    val PREFS_TO_SKIP_RESTORING: Array<String> = arrayOf(
        PREF_ACCOUNT_NAME,
        PREF_ENABLE_CLOUD_SYNC,  // The debug settings are not restored on a new device.
